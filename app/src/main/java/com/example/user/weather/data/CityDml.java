...
public class CityDml {
    ...
    public ArrayList<String> selectData(){
        ...
        try {
            ...
            int indColumnIndex = cursor.getColumnIndex(DbContract.CityEntry._ID);
            ...
            while (cursor.moveToNext()) {
                double indx=cursor.getDouble(indColumnIndex);
    ...
    public ArrayList<Weather> selectDataObj(){
        ddl=new Ddl(context);
        SQLiteDatabase db = ddl.getReadableDatabase();
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                weathers.add(new Weather("x","y",1,5));
                //weathers.add(new Weather(currentName,"demo",1,1));

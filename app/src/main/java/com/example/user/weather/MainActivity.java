       ...
       // test();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               // Toast.makeText(getApplication(),"hhhhh",Toast.LENGTH_LONG).show();
                CityDml cityDml3;
                cityDml3=new CityDml(dmcontext);
                ArrayList<Weather> x=new ArrayList<Weather>();
                //  ArrayList<Weather> weatherslist=cityDml3.getLoctionlist(x);

              if(i>4)
                test(90.000000,-30.000000);
                else
                  test(190.000000,30.000000);
...
//
        ...
        call.enqueue(new Callback<com.example.user.weather.apcsu.Example>() {
            ...
            public void onResponse(Call<com.example.user.weather.apcsu.Example> call, Response<com.example.user.weather.apcsu.Example> response) {
                ...
                /*avgTemp = response.body().getCurrent().getTempC().toString();
                String crntTempF = response.body().getCurrent().getTempF().toString();
                maxTemp = response.body().getForecast().getForecastday().get(0).getDay().getMaxtempC().toString();
                String crntmaxTempF = response.body().getForecast().getForecastday().get(0).getDay().getMaxtempF().toString();
                minTemp = response.body().getForecast().getForecastday().get(0).getDay().getMintempC().toString();
                String crntminTempF = response.body().getForecast().getForecastday().get(0).getDay().getMintempF().toString();
                humidity = response.body().getCurrent().getHumidity().toString();
                pressure = response.body().getCurrent().getPressureIn().toString();
                String pressureMb = response.body().getCurrent().getPressureMb().toString();
                wind = response.body().getCurrent().getWindKph().toString();
                String windMph = response.body().getCurrent().getWindMph().toString();
                windDir = response.body().getCurrent().getWindDir().toString();
                visivility = response.body().getCurrent().getVisKm().toString();
                String visivilityM = response.body().getCurrent().getVisMiles().toString();
                sunrise = response.body().getForecast().getForecastday().get(0).getAstro().getSunrise().toString();
                sunset = response.body().getForecast().getForecastday().get(0).getAstro().getSunset().toString();
                location = response.body().getLocation().toString();
                currentConditionText = response.body().getCurrent().getCondition().toString();
                String feelC = response.body().getCurrent().getFeelslikeC().toString();
                String feelF = response.body().getCurrent().getFeelslikeC().toString();
                lastUpdate = response.body().getCurrent().getLastUpdated().toString();*/
...
//                avgTempt=(TextView)findViewById(R.id.current_temp);
//                avgTempt.setText(CtoF(crntmaxTempC));

//                crntTempRangeUnitT.setText(SFtoC(crntTempUnit));
//                crntTempUnitT = (TextView) findViewById(R.id.current_temp_unit);
//                crntTempUnitT.setText(SFtoC(crntTempUnit));
//                maxTempt=(TextView)findViewById(R.id.current_high_temp);
//                maxTempt.setText(FtoC(crntmaxTempC));
//                minTempt=(TextView)findViewById(R.id.current_low_temp);
//                minTempt.setText(FtoC(crntmiTempC));
//                crntTempRangeUnitT = (TextView) findViewById(R.id.current_range_temp_unit);
//
                 ...
                 /*day0 = response.body().getForecast().getForecastday().get(0).getDay().toString();
                 day1 = response.body().getForecast().getForecastday().get(1).getDay().toString();
                 day2 = response.body().getForecast().getForecastday().get(2).getDay().toString();
                 day3 = response.body().getForecast().getForecastday().get(3).getDay().toString();
                 day4 = response.body().getForecast().getForecastday().get(4).getDay().toString();
                ...
                day0 = response.body().getForecast().getForecastday().get(0).getDate().toString();
                day1date = response.body().getForecast().getForecastday().get(1).getDate().toString();
                day2date = response.body().getForecast().getForecastday().get(2).getDate().toString();
                day3date = response.body().getForecast().getForecastday().get(3).getDate().toString();
                day4date = response.body().getForecast().getForecastday().get(4).getDate().toString();
                ...
                day0high = response.body().getForecast().getForecastday().get(0).getDay().getMaxtempC().toString();
                day1high = response.body().getForecast().getForecastday().get(1).getDay().getMaxtempC().toString();
                day2high = response.body().getForecast().getForecastday().get(2).getDay().getMaxtempC().toString();
                day3high = response.body().getForecast().getForecastday().get(3).getDay().getMaxtempC().toString();
                day4high = response.body().getForecast().getForecastday().get(4).getDay().getMaxtempC().toString();
                ...
                day0low = response.body().getForecast().getForecastday().get(0).getDay().getMintempC().toString();
                day1low = response.body().getForecast().getForecastday().get(1).getDay().getMintempC().toString();
                day2low = response.body().getForecast().getForecastday().get(2).getDay().getMintempC().toString();
                day3low = response.body().getForecast().getForecastday().get(3).getDay().getMintempC().toString();
                day4low = response.body().getForecast().getForecastday().get(4).getDay().getMintempC().toString();
